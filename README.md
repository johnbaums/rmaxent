...
-   import raster data stored in Maxent’s binary .mxe raster format (`read_mxe`);
...
-   create MESS (multivariate environmental similarity surfaces) maps, MoD (most dissimilar variable) maps, "MoS" (most similar variable) maps (similarity) (Elith *et al.* 2010); and
